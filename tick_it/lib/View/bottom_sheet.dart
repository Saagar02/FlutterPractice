...
class ShowSheet {
  static void showbottomSheet(bool isEdit, BuildContext context,
                    ...
                    children: [
                      ...
                      Row(children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            setState(() {
                              TodoProvider.isImportant = false;
                            });
                          },
                          child: Container(
                            height: 24,
                            ...
                            child: TodoProvider.isImportant == false
                                ? const Icon(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                border:
                                    Border.all(color: Colors.white, width: 1),
                                borderRadius: BorderRadius.circular(4)),
                            child: TodoProvider.isImportant
                                ? const Icon(
                                    FontAwesomeIcons.check,
                                    size: 15,
                                    color: Colors.white,
                                      ...
                                      onTap: () async {
                                        ...
                                        String formattedDate =
                                            DateFormat.yMMMd()
                                                .format(pickedDate!);
                                        setState(() {
                                          TodoProvider.dateController.text =
                                              formattedDate;
                                        });
                                      })),
                            ],
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Container(
                                  ...
                                  child: TextField(
                                      readOnly: true,
                                      controller: TodoProvider.timeController,
                                      textAlign: TextAlign.center,
                                      style: const TextStyle(
                                          fontSize: 15.0,
                                          fontWeight: FontWeight.w500,
                                      ...
                                      onTap: () async {
                                        ...
                                        if (pickedTime != null) {
                                          ...
                                          setState(() {
                                            TodoProvider.timeController.text =
                                                formattedTime;
                                          });
                                        }
                                      })),
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      setState(() {
                                        TodoProvider.categoryController.text =
                                            "Personal";
                                      });
                                    });
                                  },
                                  child: Row(
                                    children: [
                                      Icon(Icons.person_2_outlined,
                                          color: TodoProvider.categoryController
                                                      .text ==
                                                  "Personal"
